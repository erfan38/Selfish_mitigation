...
alpha_values = np.linspace(0.01, 0.3, num_alpha_values)  # Hash rate between 0 and 0.5
attacker_utilities = []
defender_utilities = []
...
for alpha in alpha_values:
    ...
    for t in range(num_rounds):
        ...
        attacker_history = []
        defender_history = []
        attacker_history = ["Honest"]  # Initialize with "Honest"
        defender_history = ["Honest"]  # Initialize with "Honest"
